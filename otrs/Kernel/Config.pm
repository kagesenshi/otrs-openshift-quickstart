...
sub Load {
    ...
    # The database host
    $Self->{DatabaseHost} = $ENV{'OPENSHIFT_POSTGRESQL_DB_HOST'};

    $Self->{DatabasePort} = $ENV{'OPENSHIFT_POSTGRESQL_DB_PORT'};
    # The database name
    $Self->{Database} = 'otrs';

    # The database user
    $Self->{DatabaseUser} = $ENV{'OPENSHIFT_POSTGRESQL_DB_USERNAME'};

    # The password of database user. You also can use bin/otrs.CryptPassword.pl
    # for crypted passwords
    $Self->{DatabasePw} = $ENV{'OPENSHIFT_POSTGRESQL_DB_PASSWORD'};
